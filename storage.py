"""Persistence operations with atomic SQLite/PostgreSQL task transitions."""
...
def create_task(sender_id: str, recipient_id: str, input_text: str, idempotency_key: str | None) -> dict[str, str]:
    ...
    with immediate_transaction() as db:
        # Serialize this sender's idempotency checks on PostgreSQL. NO KEY
        # UPDATE remains compatible with foreign-key checks from other senders.
